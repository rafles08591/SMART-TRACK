  ...
  return (
    <div style={{ display: "flex", gap: 8, margin: "14px 0", flexWrap: "wrap" }}>
      <style>{`
        ...
        @keyframes parpadeoAzulTab {
          0%, 100% { box-shadow: 0 0 0 0 rgba(56,189,248,0.85); background-color: rgba(56,189,248,0.12); }
          50% { box-shadow: 0 0 0 8px rgba(56,189,248,0); background-color: rgba(56,189,248,0.45); }
        }
        ...
        .tab-aviso-azul { border: 2px solid #38BDF8 !important; color: #38BDF8 !important; font-weight: 800 !important; animation: parpadeoAzulTab 0.9s ease-in-out infinite; }
      `}</style>
      {lista.map((t) => {
        const estado = estadoTabs && estadoTabs[t.key];
        const claseExtra = estado === "pendiente" ? "tab-pendiente" : estado === "completo" ? "tab-completo" : estado === "aviso_nuevo" ? "tab-aviso-nuevo" : estado === "pendiente_urgente" ? "tab-pendiente-urgente" : estado === "parpadeo_verde" ? "tab-parpadeo-verde" : estado === "aviso_azul" ? "tab-aviso-azul" : "";
        return (
