...
// Fecha en zona horaria de México (no UTC), para que el día cambie a las 12:00 am local
...
function lastOfMonthISO() {
  const [y, m] = todayISO().split("-").map(Number);
  const last = new Date(y, m, 0); // día 0 del mes siguiente = último del mes actual
